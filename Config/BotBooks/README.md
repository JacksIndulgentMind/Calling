...
| `edge_pad` | `goto marker=edge_pad` then `airDive marker=edge_pad`. Jump-gen JumpLength searches the chord; airDive if FindPath is incomplete. Island stand recalls to the lip. |
