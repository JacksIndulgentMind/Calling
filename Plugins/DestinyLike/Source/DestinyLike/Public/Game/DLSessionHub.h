...
#include "DLSessionHub.generated.h"
 ...
 */
UCLASS()
class DESTINYLIKE_API UDLSessionHub : public UGameInstanceSubsystem, public FTickableGameObject
{
	GENERATED_BODY()
...
public:
	...
	void PushSnapshots(EDLHubSnapshotReason Reason, const FGuid& OnlySeat = FGuid());
