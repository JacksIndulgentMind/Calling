...
#include "DLTunes.generated.h"

USTRUCT(BlueprintType)
struct DESTINYLIKE_API FDLTickTune
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct DESTINYLIKE_API FDLMovementTune
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct DESTINYLIKE_API FDLCombatTune
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct DESTINYLIKE_API FDLWeaponMotorTune
{
	GENERATED_BODY()
...
struct DESTINYLIKE_API FDLAgentLookTune
{
...
USTRUCT(BlueprintType)
struct DESTINYLIKE_API FDLAbilityTune
{
	GENERATED_BODY()
